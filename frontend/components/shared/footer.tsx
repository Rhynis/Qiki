      ...
      <div className="mx-auto grid max-w-6xl gap-7 px-4 py-8 text-sm text-slate-600 md:grid-cols-2 lg:grid-cols-[1fr_0.9fr_1.15fr_1.25fr]">
        <div>
          ...
          <p className="mt-2 max-w-sm">
            {t('tagline', { area: protectVi(SHOP_INFO.deliveryAreaLabel) })}
          </p>
          <Link
        ...
        <div className="space-y-2">
          <p className="font-semibold text-slate-950">{t('contact')}</p>
          ...
          <a className="block hover:text-slate-950" href={SHOP_INFO.landline.href}>
            {t('landline', { number: SHOP_INFO.landline.label })}
          </a>
        </div>
        <div className="space-y-3">
          <p className="font-semibold text-slate-950">{t('store')}</p>
          ...
          <div className="flex gap-2">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">
                {t('oldAddress', { address: protectVi(SHOP_INFO.addressOld) })}
              </p>
            </div>
          </div>
        </div>
        <div className="space-y-3">
          <p className="font-semibold text-slate-950">{t('storeMap')}</p>
          <StoreMap />
          <a
