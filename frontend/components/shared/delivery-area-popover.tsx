...
export function DeliveryAreaPopover() {
  ...
  const deliveryWardText = t('deliveryWardsText', { wards: SHOP_INFO.deliveryWards.join(', ') })
  return (
    <HoverCard openDelay={100} closeDelay={150}>
      <HoverCardTrigger asChild>
        <button
          aria-label={t('deliveryWardsAria')}
      ...
      <HoverCardContent
        ...
        side="top"
      >
        <p className="text-sm font-medium text-slate-950">{t('deliveryArea')}</p>
